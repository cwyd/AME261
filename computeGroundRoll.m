function groundRollDist = computeGroundRoll(W1, hAirport, CD0, ev, AR, S, b, CLMax, fricCoeff, wingDistFromGround)

%COMPUTEGROUNDROLL will calculate a rough estimate for the ground roll
%distance for a proleller-powered aircraft. This algorithm assumes that
%T_rev = 0!!!
%
%INPUTS: 
%   - %INPUTS:
