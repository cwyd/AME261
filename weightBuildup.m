...
L_m = 3;        % Length of main landing gear [ft]
L_n = 15;        % Nose gear length [in]
...
S_f = 1834;        % Fuselage wetted area [ft^2]
S_ht = 272.68;       % Horizontal tail area [ft^2]
S_vt = 290.62;       % Vertical tail area [ft^2]
S_w = 1498;        % Trapezoidal wing area [ft^2]
t_c = 0.12;
V_i = 25;        % Integral tanks volume [gal]
V_pr = 35000;       % Volume of pressurized section [gal]
V_t = 100;        % Total fuel volume [gal]
W_dg = 18055;       % Design gross weight [lb]
W_en = 290;       % Engine weight, each, [lb]
W_fw = 100;       % Weight of fuel in wing [lb]
W_l = 18055;        % Landing design gross weight [lb]
